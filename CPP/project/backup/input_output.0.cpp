...
void input_str( string str, string *p){  // input string to string pointer
        do{
...
void input_int( string str, int *p){  // input int to int pointer
        int error;
...
void input_float( string str, float *p){  // input float to float pointer
...
void input_double( string str, double *p){  // input double to double pointer
...
void input_bool( string str, bool *p){  // input bool to bool pointer 
...
void input_bool_yn( bool *p){  // input bool to bool pointer 
        char ch;
        int bad_input=0;
        do {                  // get input  with error checking
            if (cin.fail())cin.clear();
...
//<inherit group> 
    ...
    public:
        ...
        void input();
        //friend void input_str(string,string );
        //friend void input_int(string, int );
        //friend void input_bool_yn(bool);
        
        void display();
};

void Student::input(){
        input_str("Enter the name of student: ", &std_name);
        input_int( "Enter the roll no: ",  &roll_no);
