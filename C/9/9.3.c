...
{
	return strcmp(((struct employee*)p)->name,  //standard lib function for use in qsort  //type casting
...
//void get_val_strct_cmpny (struct company c){

//for (int i=0; i<5;i++)read_employee(&emp[i]);}

//output the value in structure emp
